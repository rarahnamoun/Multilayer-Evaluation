...
# Define a prompt for the Llama model to act as a judge with all gold answers
...
tracking_file_path = 'PQPprogress_tracking33.json'
...
for i, example in enumerate(data):
    ...
    # Prompt for scoring with all the gold answers
    ...
    output_file_with_gold = f'PQP_updated_data_with_ref_llamma70b_{metric_col_name}.json'
    output_file_without_gold = f'PQP_updated_data_without_ref_llamma70b_{metric_col_name}.json'
